...
for tag in android-lint android-sdk aria2c aria2c-webui buildah-builder eslint ffvnc flutter-sdk golang hugo-pandoc mariadb-dbmate openapi platformio postgres-dbmate qbittorrent; do
    cd "$tag"
